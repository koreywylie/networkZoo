...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton_addClassification = QtWidgets.QPushButton(self.verticalFrame_controls)
        self.pushButton_addClassification.setObjectName("pushButton_addClassification")
        self.horizontalLayout_8.addWidget(self.pushButton_addClassification)
        self.pushButton_rmClassification = QtWidgets.QPushButton(self.verticalFrame_controls)
        self.pushButton_rmClassification.setObjectName("pushButton_rmClassification")
        self.horizontalLayout_8.addWidget(self.pushButton_rmClassification)
        self.verticalLayout_2.addLayout(self.horizontalLayout_8)
        self.listWidget_Classifications = QtWidgets.QListWidget(self.verticalFrame_controls)
        self.listWidget_Classifications.setObjectName("listWidget_Classifications")
        self.verticalLayout_2.addWidget(self.listWidget_Classifications)
        ...
        self.pushButton_showMaxOverlap = QtWidgets.QPushButton(self.groupBox_2)
        self.pushButton_showMaxOverlap.setEnabled(True)
        self.pushButton_showMaxOverlap.setMinimumSize(QtCore.QSize(200, 0))
        self.pushButton_showMaxOverlap.setMaximumSize(QtCore.QSize(200, 16777215))
        self.pushButton_showMaxOverlap.setObjectName("pushButton_showMaxOverlap")
        self.verticalLayout_4.addWidget(self.pushButton_showMaxOverlap)
        ...
        self.menuClassifications = QtWidgets.QMenu(self.menubar)
        self.menuClassifications.setEnabled(True)
        self.menuClassifications.setObjectName("menuClassifications")
        ...
        self.action_FindDuplicateICAClassifications.setEnabled(False)
        ...
        self.action_ChangeDefaultSettings = QtWidgets.QAction(MainWindow)
        self.action_ChangeDefaultSettings.setObjectName("action_ChangeDefaultSettings")
        ...
        self.action_EditPreferrences = QtWidgets.QAction(MainWindow)
        self.action_EditPreferrences.setObjectName("action_EditPreferrences")
        self.action_LoadDemoICAcomps = QtWidgets.QAction(MainWindow)
        self.action_LoadDemoICAcomps.setObjectName("action_LoadDemoICAcomps")
        self.action_SliceLayoutMatrix = QtWidgets.QAction(MainWindow)
        self.action_SliceLayoutMatrix.setCheckable(True)
        self.action_SliceLayoutMatrix.setObjectName("action_SliceLayoutMatrix")
        self.action_EditDisplayOptions = QtWidgets.QAction(MainWindow)
        self.action_EditDisplayOptions.setObjectName("action_EditDisplayOptions")
        self.action_EditOutputParams = QtWidgets.QAction(MainWindow)
        self.action_EditOutputParams.setObjectName("action_EditOutputParams")
        self.action_AllowICAMulticlassifications = QtWidgets.QAction(MainWindow)
        self.action_AllowICAMulticlassifications.setCheckable(True)
        self.action_AllowICAMulticlassifications.setObjectName("action_AllowICAMulticlassifications")
        self.action_SaveAnalysisAs = QtWidgets.QAction(MainWindow)
        self.action_SaveAnalysisAs.setObjectName("action_SaveAnalysisAs")
        self.action_LoadICAtimeseries = QtWidgets.QAction(MainWindow)
        self.action_LoadICAtimeseries.setEnabled(True)
        self.action_LoadICAtimeseries.setObjectName("action_LoadICAtimeseries")
        self.menuFile.addSeparator()
        self.menuFile.addAction(self.action_LoadAnalysis)
        self.menuFile.addAction(self.action_SaveAnalysis)
        self.menuFile.addAction(self.action_SaveAnalysisAs)
        self.menuFile.addAction(self.action_ResetAnalysis)
        self.menuFile.addSeparator()
        self.menuFile.addAction(self.action_runAnalysis)
        self.menuFile.addSeparator()
        self.menuFile.addAction(self.action_ResetDisplay)
        self.menuFile.addAction(self.action_SaveDisplay)
        self.menuFile.addSeparator()
        self.menuFile.addAction(self.action_Quit)
        self.menuEdit.addAction(self.action_EditPreferrences)
        self.menuEdit.addAction(self.action_EditDisplayOptions)
        self.menuEdit.addAction(self.action_EditOutputParams)
        self.menuNetworks.addAction(self.action_LoadICAcomps)
        self.menuNetworks.addAction(self.action_LoadICAtimeseries)
        ...
        self.menuClassifications.addAction(self.action_RenameClassifications_select)
        self.menuClassifications.addSeparator()
        self.menuClassifications.addAction(self.action_AllowICAMulticlassifications)
        self.menuClassifications.addAction(self.action_FindDuplicateICAClassifications)
        self.menuClassifications.addAction(self.action_FindDuplicateICNClassifications)
        self.menuClassifications.addSeparator()
        self.menuClassifications.addAction(self.action_FindProbableClassifications)
        self.menuClassifications.addAction(self.action_FindQuestionableClassifications)
        self.menuClassifications.addSeparator()
        self.menuClassifications.addSeparator()
        self.menuClassifications.addAction(self.action_ClearClassifications_select)
        self.menuClassifications.addAction(self.action_ClearClassifications_all)
        self.menuHelp.addSeparator()
        self.menuHelp.addAction(self.action_ShowAboutInfo)
        self.menuHelp.addSeparator()
        self.menuHelp.addAction(self.action_ShowStepByStepTutorial)
        self.menuHelp.addSeparator()
        self.menuHelp.addAction(self.action_LoadDemoICAcomps)
        self.menuOutput.addAction(self.action_createOutput)
        self.menuOutput.addAction(self.action_createBinaryMasks)
        self.menubar.addAction(self.menuFile.menuAction())
        self.menubar.addAction(self.menuEdit.menuAction())
        self.menubar.addAction(self.menuNetworks.menuAction())
        self.menubar.addAction(self.menuClassifications.menuAction())
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_addClassification.setText(_translate("MainWindow", "Set Classification (ICA > ICN)"))
        self.pushButton_rmClassification.setText(_translate("MainWindow", "Remove Classification"))
        ...
        self.pushButton_showMaxOverlap.setText(_translate("MainWindow", "Go To Max. Overlapping (x,y,z)"))
        ...
        self.menuClassifications.setTitle(_translate("MainWindow", "Classifications"))
        ...
        self.action_ClearICNlist_all.setText(_translate("MainWindow", "Clear all ICN && noise templates"))
        ...
        self.action_createOutput.setText(_translate("MainWindow", "Create Figures && Tables"))
        ...
        self.action_FindDuplicateICNClassifications.setText(_translate("MainWindow", "Find duplicated ICN mappings"))
        ...
        self.action_ClearICAlist_select.setText(_translate("MainWindow", "Remove select ICA components"))
        self.action_ClearICNlist_select.setText(_translate("MainWindow", "Remove select templates"))
        self.action_RenameICAlist_select.setText(_translate("MainWindow", "Rename ICA components"))
        self.action_RenameICNtemplates_select.setText(_translate("MainWindow", "Rename select templates"))
        self.action_FindDuplicateICAClassifications.setText(_translate("MainWindow", "Find ICA comp. multiclassifications"))
        self.action_DuplicateICA_select.setText(_translate("MainWindow", "Duplicate ICA comps (~multiclassification)"))
        self.action_ClearClassifications_select.setText(_translate("MainWindow", "Reset select classifications"))
        ...
        self.action_ChangeDefaultSettings.setText(_translate("MainWindow", "Change other default settings"))
        self.action_FindProbableClassifications.setText(_translate("MainWindow", "Find likely classifications"))
        self.action_FindQuestionableClassifications.setText(_translate("MainWindow", "Find questionable classifications"))
        self.action_EditPreferrences.setText(_translate("MainWindow", "Default preferrences"))
        self.action_LoadDemoICAcomps.setText(_translate("MainWindow", "Load demo ICA comps"))
        self.action_SliceLayoutMatrix.setText(_translate("MainWindow", "Layout slices in rect. grid"))
        self.action_EditDisplayOptions.setText(_translate("MainWindow", "Display options"))
        self.action_EditOutputParams.setText(_translate("MainWindow", "Output parameters"))
        self.action_AllowICAMulticlassifications.setText(_translate("MainWindow", "Allow ICA comp. multiclassifications"))
        self.action_SaveAnalysisAs.setText(_translate("MainWindow", "Save analysis as"))
        self.action_LoadICAtimeseries.setText(_translate("MainWindow", "Load ICA time series"))
